 ...
 * "release_V1_GC4053_MIPI_2lane_base24M_30fps_20181206.txt" so future
 * debugging can read the bit meaning directly here. */
static const gc4053_reginfo_t init_reglist_MIPI_2lane_24Minput_RAW10_1920x1080_30fps[] = {
    /****system****/
    {0xfe, 0x80},
    {0xfe, 0x80},
    {0xfe, 0x80},
    ...
    /*ISP (page 1)*/
    /* ISP / CCM tuning for GC4053 on P4 ISP (DPC and BFF off, BFF SRAM
     ...
     * is fixed by re-asserting 0x3e in gc4053_set_stream. */
    // {0x3e, 0x91},
