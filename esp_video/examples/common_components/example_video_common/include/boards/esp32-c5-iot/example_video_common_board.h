...
/**
 * @brief ESP32-C5-IOT configuration
 */
...
#define EXAMPLE_SCCB_I2C_SCL_PIN_INIT_BY_APP            3
#define EXAMPLE_SCCB_I2C_SDA_PIN_INIT_BY_APP            2
 ...
 */
#define EXAMPLE_SPI_CAM_0_SCCB_I2C_SCL_PIN              3
#define EXAMPLE_SPI_CAM_0_SCCB_I2C_SDA_PIN              2
 ...
 * @brief SPI camera sensor configuration
 */
#define EXAMPLE_SPI_CAM_0_CS_PIN                        27
#define EXAMPLE_SPI_CAM_0_SCLK_PIN                      25
#define EXAMPLE_SPI_CAM_0_DATA0_IO_PIN                  23
#define EXAMPLE_SPI_CAM_0_DATA1_IO_PIN                  -1

/**
 * @brief SPI camera sensor clock resource configuration
 */
#define EXAMPLE_SPI_CAM_0_XCLK_PIN                      24
